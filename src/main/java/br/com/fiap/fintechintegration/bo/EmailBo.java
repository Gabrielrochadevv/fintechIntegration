package br.com.fiap.fintechintegration.bo;
...
public class EmailBo {
    ...
    private static final String EMAIL_FROM = "teste@fiap.com.br";
    private static final String APP_PASSWORD = "gsog fehf dgxu jdbw";
